...
class Signature extends CI_Controller {
	...
	public function index() {
		...
		$data['allsign'] = $this -> Signature_model -> list_signatures();
		/*//$data[$allpages->id];
		 //	echo '<pre>';
		 //print_r ( $data);
		 //echo '</pre>';	*/
		$this -> load -> view('admin/signature/signature_html.php', $data);
	}
	...
	public function add() {
		...
		$this -> form_validation -> set_rules('explanation', 'Açıklama', 'xss_clean|trim');
		...
		if ($this -> form_validation -> run() !== FALSE) {
			...
			$data['msg'] = $this -> Signature_model -> add();

		}

		$this -> load -> view('admin/signature/add_signature_html.php', $data);
	...
	public function update() {
		...
		$data['signature'] = $this -> Signature_model -> get_signature();

		$this -> load -> view('admin/signature/edit_signature_html.php', $data);
	}
	...
	public function delete() {
		...
		$query = $this -> Signature_model -> delete();
