...
<h2><i class="icon-user"></i> Araç Kaza Listesi</h2>
<div class="box-icon">
...
<?php $c = 0;
if ($all_accident_car){
foreach ( $all_accident_car as $row ):
?>
<tr class="<?php // echo ($c++%2==1) ? "odd":"even" ?>">

<td class="center"><?php echo tr_date($row -> accident_date); ?></td>
<td class="center"> <?php echo $row -> repairs_price; ?></td>
...
<a class="btn btn-info" href="<?php echo base_url() . '/admin/'.$pathname.'/update_accident/'.$row -> id; ?>">
<i class="icon-edit icon-white"></i>
Düzenle
</a>

	<input type="submit" class="btn btn-danger" onclick="show_confirm('<?php echo '/admin/'.$pathname.'/delete_accident/'.$row->id; ?>')"  value="Sil" name="delete_button"/>
