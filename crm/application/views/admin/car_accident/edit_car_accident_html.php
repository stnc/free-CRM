...
if ($.'$pathname'.){		
	...
	echo form_open (base_url().'admin/'.$pathname.'/add_accident/' ,array('id' => 'form-horizontal','class'=>'form-horizontal')); ?> 
 <fieldset>	
				...
				<?php echo form_submit(array("name"=>"passwordsubmit","class"=>"btn btn-primary", "value"=>'Bilgileri Kaydet')) ?>
						  ...
						  <fieldset>
							<legend><?php  echo $this -> lang -> line('car_accident_Text'); ?></legend>
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="accident_date" name="accident_date" 
	value="<?php echo set_value('accident_date', tr_date($row -> accident_date)); ?>'/>
							...
							<div class="control-group<? echo form_error('repairs_price') != '' ? ' error' : ''; ?>">
								...
								<div class="controls">
				<input class="input-xlarge" id="repairs_price" name="repairs_price" type="text" 
				value="<?php echo set_value('repairs_price', $row -> repairs_price); ?>">
				<span class="help-inline"> <? echo form_error('repairs_price'); ?></span>
							  ...
							  <div class="controls">
			<textarea  style="width: 277px; height: 213px;" id="comment" name="comment" rows="3"><?php echo set_value('comment', $row -> comment); ?></textarea>
