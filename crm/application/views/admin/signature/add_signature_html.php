		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#"><?php  echo $this -> lang -> line('signature_Text'); ?></a>
					</li>
				</ul>
			</div>
            ...
            <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i><?php  echo $this -> lang -> line('signature_Text'); ?></h2>
						<div class="box-icon">
 ...
 <fieldset>	
		...
		<span class="help-inline"></span>
					...
					<label class="control-label" for="explanation"><?php echo $this -> lang -> line('signature_explanation'); ?></label>
							  <div class="controls">
			<textarea  style="width: 879px; height: 200px;" id="explanation" name="explanation" rows="3"><?php echo set_value('explanation'); ?></textarea>
