...
<?php  $this -> load -> view('admin/top_bar.php'); ?>
	...
	echo form_open_multipart (base_url().'admin/'.$pathname.'/update/' , array('id' => 'form-horizontal','class'=>'form-horizontal')); ?> 
 <fieldset>	
		...
		<label class="control-label" for="signature_number"><?php echo $this -> lang -> line('signature_date'); ?></label>
		<div class="controls">
		...
		<span class="help-inline"></span>
							  ...
							  <div class="control-group<? echo form_error('explanation') != '' ? ' error' : ''; ?>">			
					<label class="control-label" for="explanation"><?php echo $this -> lang -> line('signature_explanation'); ?></label>
							  <div class="controls">
<textarea style="width: 879px; height: 200px;" id="explanation" name="explanation" rows="3"><?php echo set_value('explanation', $row -> explanation); ?></textarea>
	<input type="hidden" id="pid" value="1" name="pid">		
								 <span class="help-inline"> <? echo  form_error('explanation')  ?></span>
							  </div>
							</div>
