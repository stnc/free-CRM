...
<?php  $this -> load -> view('admin/top_bar.php'); ?>
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#"><?php  echo $this -> lang -> line('movable_Text'); ?></a>
					</li>
				</ul>
			</div>
            ...
            <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i><?php  echo $this -> lang -> line('movable_Text'); ?></h2>
						<div class="box-icon">
 ...
 <fieldset>	
				...
				<?php echo form_submit(array("name"=>"passwordsubmit","class"=>"btn btn-primary", "value"=>'Bilgileri Kaydet')) ?>
						  ...
						  <fieldset>
							<legend><?php  echo $this -> lang -> line('movable_Text'); ?></legend>
	...
	<label class="control-label" for="personal_id"> <?php echo $this -> lang -> line('movable_personal_id'); ?> </label>
								<div class="controls">
									  <select  id="personal_id" name="personal_id"" data-rel="chosen">
										...
										if ( $this->input->post('personal_id')==$v->id ){ ?>  	
		...
		<div class="controls">
	<input type="text" class="input-xlarge" id="movable_number" name="movable_number" value="<?php echo set_value('movable_number'); ?>">
		<span class="help-inline"> <? echo  form_error('movable_number')  ?></span>
			...
			<div class="controls">
		<input type="text" class="input-xlarge" id="series_number" name="series_number" value="<?php echo set_value('series_number'); ?>">
			...
			<div class="control-group<? echo form_error('unit') != '' ? ' error' : ''; ?>">
				<label class="control-label" for="unit"><?php echo $this -> lang -> line('movable_unit'); ?></label>
							  <div class="controls">
	<input type="text" class="input-xlarge" id="unit" name="unit" value="<?php echo set_value('unit'); ?>">
							 ...
							 <div class="control-group<? echo form_error('give_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="give_date" name="give_date" value="<?php echo set_value('give_date'); ?>">
							 ...
							 <div class="control-group<? echo form_error('take_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="take_date" name="take_date" value="<?php echo set_value('take_date'); ?>">
