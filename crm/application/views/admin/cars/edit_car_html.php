 ...
 <fieldset>	
				...
				<?php echo form_submit(array("name"=>"passwordsubmit","class"=>"btn btn-primary", "value"=>'Bilgileri Kaydet')) ?>
						...
						<div class="control-group<? echo form_error('license_plate') != '' ? ' error' : ''; ?>">
								...
								<div class="controls">
				<input class="input-xlarge focused" id="license_plate" name="license_plate" type="text" value="<?php echo set_value('license_plate', $row -> license_plate); ?>">
				<span class="help-inline"> <? echo form_error('license_plate'); ?></span>
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="delivery_date" 
	name="delivery_date" value="<?php echo set_value('delivery_date', tr_date($row -> delivery_date, '-')); ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge" id="delivery_km" name="delivery_km" value="<?php echo set_value('delivery_km', $row -> delivery_km); ?>">
							...
							<div class="control-group<? echo $err_form1 = form_error('back_to_date') != '' ? ' error' : ''; ?>">
								...
								<div class="controls">
				<input class="input-xlarge datepicker" id="back_to_date" name="back_to_date" type="text" value="<?php echo set_value('back_to_date', tr_date($row -> back_to_date, '-')); ?>">
				<span class="help-inline"> <? echo form_error('back_to_date'); ?></span>
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge" id="total_accident" name="total_accident" value="<?php echo set_value('total_accident', $row -> total_accident); ?>">
							 ...
							 <div class="control-group<? echo form_error('delivery_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge" id="total_equivalent" name="total_equivalent" value="<?php echo set_value('total_equivalent', $row -> total_equivalent); ?>">
							 ...
							 <div class="control-group<? echo form_error('first_accident_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="first_accident_date" name="first_accident_date" value="<?php echo set_value('first_accident_date', tr_date($row -> first_accident_date, '-')); ?>">
							 ...
							 <div class="control-group<? echo form_error('last_accident_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge datepicker" id="last_accident_date" name="last_accident_date" value="<?php echo set_value('last_accident_date', tr_date($row -> last_accident_date, '-')); ?>">
							 ...
							 <div class="control-group<? echo form_error('delivery_date') != '' ? ' error' : ''; ?>">
							  ...
							  <div class="controls">
	<input type="text" class="input-xlarge" id="back_to_km" name="back_to_km" value="<?php echo set_value('back_to_km', $row -> back_to_km); ?>">
							  ...
							  <div class="controls">
			<textarea  style="width: 277px; height: 213px;" id="notes" name="notes" rows="3"><?php echo set_value('notes', $row -> notes); ?></textarea>
