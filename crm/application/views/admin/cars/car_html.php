...
<?php  $this->load->view('admin/top_bar.php'); ?>
	<!-- topbar ends -->
		...
		<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Araç Listesi</h2>
						<div class="box-icon">
		...
		<?php $c = 0; 
		if ($allcar){												
	foreach ( $allcar as $row ): ?>
	<tr class="<?php // echo ($c++%2==1) ? "odd":"even" ?>">
								<td> <?php echo $row->license_plate; ?>  </td>
								<td class="center"><?php echo tr_date($row->delivery_date); ?> </td>
								<td class="center"> <?php echo $row->delivery_km; ?></td>
								<td class="center">
									<?php echo tr_date($row-> back_to_date) ;?>
								</td>
								<td class="center">
